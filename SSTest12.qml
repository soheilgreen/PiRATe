...
Item
{
   ...
   Tests
   {
       ...
       onFinished:
       {
           ...
           Global.SSTest12Result = te_result.text;
   ...
   CustomResult
   {
    ...
    CustomButton
    {
        ...
        onClicked:
        {
            var result = test.ssTest12(Global.pathText, path.path, chk_bitflip.checked, chk_verbose.checked ? 1 : 0);
        }
