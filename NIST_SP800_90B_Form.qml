...
Item
{
   ...
   Tests
   {
       ...
       onFinished:
       {
           ...
           Global.NIST_SP800_90BResult = te_result.text;
...
//       te_result.text = Global.BorelTestResult
   ...
   CustomCheckBox
   {
     ...
     onCheckedChanged: { chk_noniid.checked = !checked; }
   ...
   CustomCheckBox
   {
     ...
     text: qsTr("NONIID Test");
     checked: false

     font.family: Global.font_eng.name
     font.pixelSize: parent.width * 0.022

     onCheckedChanged: { chk_iid.checked = !checked; }
   }
...
//    }
    ...
    CustomButton
    {
        ...
        onClicked:
        {
            ...
            if(chk_iid.checked)
              result = test.nist_Test(Global.pathText, 1);
            else
                result = test.nist_Test(Global.pathText, 0);
